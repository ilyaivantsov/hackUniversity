            ...
            <div class="pushy-content">
              <div class="profil_img" >
                ...
                <ul>
                    ...
                    <li>
                      <a href="../customer/index.php">Мои заказы</a>
                </li>

                        <li>
                      <a href="../executor/index.php">Мои задания</a>
                </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
          <div class="row">
           <div class="col-lg-5 col-md-5 ">
             <div class="actual">Создать задание</div>
              <div class="ex_task">
                <div class="task">
                  <form action="send.php" method="post">
                    <input type="text" id="username" name="name" style="display: none;" >
                    <input type="text" name="task" class="form-control" placeholder="Чем вам помочь?">
                    <input type="text" name="price" class="form-control" required placeholder="Цена">
                    <input type="submit" class="btn btn-info" placeholder="Опубликовать">
                  </form>
                </div>
               <div class="actual" style="color:#fff">Активные задания</div>
                <?php 
                   session_start();
                   $mysqli = new mysqli("localhost","u0494820_default","5HFc8f!U","u0494820_default");
                   $result = $mysqli->query("SELECT * FROM hack WHERE `name`='$_SESSION[nick]'");
                   $i = 0;
                   while(($row = $result->fetch_assoc() ) != false && $i < 5)
                    {
                      ...
                      $i++;
                       ...
                       if($i == 0)
                            echo "<h2>Нет активных заданий </h2>";
                    $mysqli->close();
                ?>
             </div>
           </div>
