...
function createCall(numcall,butt) {
  $(butt).replaceWith('<button type="button" class="take_task btn btn-danger" id="cancelButton">Завершить</button>');
  $(butt).remove();
  $('#cancelButton').click(function() {
    currentCall.hangup();
...
$('.take_task').click(function(){
    createCall($(this).attr("data-name"),this);
})
