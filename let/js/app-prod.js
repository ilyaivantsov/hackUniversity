...
function onAuthResult(e) {
  ...
  if (e.result) { 
    ...
    $('#auth').replaceWith('<a href="https://spbchooseus.ru/let/customer" class="btn btn-lg btn-default" id="customer">Я заказчик</a><a href="https://spbchooseus.ru/let/executor" class="btn btn-lg btn-default" id="executor" style="margin-left:10px">Я исполнитель</a>');
    dialog.close();
    //showLocalVideo(true);      
  } else {
